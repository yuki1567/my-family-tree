...
class CSSStyleDeclarationElementStyle {
    ...
    getElementStyle() {
        ...
        const cssText = this.element[PropertySymbol.attributes][PropertySymbol.namedItems].get('style')?.[PropertySymbol.value];
        if (cssText) {
            const propertyManager = new CSSStyleDeclarationPropertyManager_js_1.default({ cssText });
