...
class HTMLFormElement extends HTMLElement_js_1.default {
    ...
    constructor() {
        super();
        ClassMethodBinder_js_1.default.bindMethods(this, [EventTarget_js_1.default, Node_js_1.default, Element_js_1.default, HTMLElement_js_1.default, HTMLFormElement], {
            bindSymbols: true,
