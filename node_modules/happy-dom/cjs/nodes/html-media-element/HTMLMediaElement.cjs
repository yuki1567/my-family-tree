...
const DOMTokenList_js_1 = __importDefault(require("../element/DOMTokenList.cjs"));
...
class HTMLMediaElement extends HTMLElement_js_1.default {
    ...
    get controlsList() {
        if (this[PropertySymbol.controlsList] === null) {
            this[PropertySymbol.controlsList] = new DOMTokenList_js_1.default(this, 'controlslist');
        }
