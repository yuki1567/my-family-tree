 ...
 */
class WindowClassExtender {
    /**
     * Extends classes with a "window" property.
     *
     * @param window Window.
     */
    static extendClass(window) {
        ...
        window.SVGDocument = SVGDocument;
        // DocumentFragment
        ...
        // CSSStyleDeclaration
        class CSSStyleDeclaration extends CSSStyleDeclaration_js_1.default {
        }
...
exports.default = WindowClassExtender;
//# sourceMappingURL=WindowClassExtender.cjs.map